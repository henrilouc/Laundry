                                        ...
                                        <div class="alert alert-danger rounded-0 rounded-bottom">
                                            <ul>
                                                @foreach ($errors->all() as $error)
                                                    <li class="float-start text-white"><strong><small>{{ $error }}</small></strong></li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    @endif
                                    <div class="card-body cardStyle ">
                                        <div class="col-md-5">
                                            <div class="input-group input-group-static my-3 ">
                                                ...
                                                <input type="number" name="amount" id="Quantity" class="form-control" oninput="convertAmount({{$prices}})" autocomplete="off"  />
                                            </div>
                                        </div>
