                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            ...
                            <h4 class="mb-0">{{$cards_data[0]->Pendentes}}</h4>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            ...
                            <h4 class="mb-0">{{$cards_data[0]->Aprovadas}}</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                </div>
                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            ...
                            <h4 class="mb-0">{{$cards_data[0]->Vendas}}</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                </div>
                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            ...
                            <h4 class="mb-0">R$ {{$cards_data[0]->Valor_vendas}}</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                </div>
