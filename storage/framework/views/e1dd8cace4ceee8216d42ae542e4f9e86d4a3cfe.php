            ...
            <div class="col-md-12">
                <div class="card border-secondary ">
                    ...
                    <ul style="list-style: none;">
                        <li><b>NOME:</b> <?php echo e($transaction->name); ?></li>
                        <br>
                        <li><b>ROL:</b>  <?php echo e($transaction->id); ?></li>
                        <li><b>PESO(KG):</b>  <?php echo e($transaction->amount); ?></li>
                        <li><b>DATA ENTRADA:</b>  <?php echo e($transaction->created_at); ?></li>
                        <br>
                        <li><b>RECEBIDO POR:</b></li>
                        <li><b>DATA DE RECEBIMENTO:</b> <?php echo e(date('d/m/Y H:i ',strtotime(Carbon\Carbon::now()))); ?></li>
                    </ul>
                        <?php if($transaction->single_purchase == 1): ?>
                            <ul style="list-style: none;">
                                <li><b>VALOR:</b> R$<?php echo e($transaction->value - $transaction->discount); ?></li>
                                <li><b>DESCONTO:</b>R$<?php echo e($transaction->discount); ?></li>
                                _____________________________________________________
                                <li><b>TOTAL:</b>R$<?php echo e($transaction->value); ?></li>
                            </ul>
                        <?php else: ?>
                            <ul style="list-style: none;">
                                <li><b>SALDO:</b> <?php echo e(Auth::user()->credit->amount); ?>KG</li>
                            </ul>
                        <?php endif; ?>
...
<?php /**PATH B:\Programming\Laundry\resources\views/reports/cloth.blade.php ENDPATH**/ ?>