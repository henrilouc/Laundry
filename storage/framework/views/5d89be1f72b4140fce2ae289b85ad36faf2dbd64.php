...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-3">
                                <label for="cpf" class="col-md-4 col-form-label text-md-end"><?php echo e(__('CPF')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="cpf" value="<?php echo e(old('cpf')); ?>" required autocomplete="cpf" autofocus>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-3">
                                <label for="phone" class="col-md-4 col-form-label text-md-end"><?php echo e('Telefone'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-3">
                                <label for="birth" class="col-md-4 col-form-label text-md-end"><?php echo e('Data de Nascimento'); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="birth" value="<?php echo e(old('birth')); ?>" required autocomplete="birth">
